...
namespace DmToolsApp
{
    public static class MauiProgram
    {
        public static MauiApp CreateMauiApp()
        {
            ...
            builder.Services.AddTransient<PlayCampaignViewModel>();
            builder.Services.AddTransient<MainPage>();
            builder.Services.AddTransient<PlaySessionViewModel>();
            builder.Services.AddTransient<PlaySessionPage>();
            builder.Services.AddTransient<PlaySceneViewModel>();
            builder.Services.AddTransient<PlayScenePage>();
